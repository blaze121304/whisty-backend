...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        sampleWhiskeys.add(Whiskey.builder()
                ...
                .characteristics(List.of(WhiskeyCharacteristic.SHERRY))
                .abv(40.0)
                .volume(700.0)
                .nation("스코틀랜드")
                .region("스페이사이드")
        ...
        sampleWhiskeys.add(Whiskey.builder()
                ...
                .brand("Laphroaig")
                .category(WhiskeyCategory.SINGLE_MALT)
                .characteristics(List.of(WhiskeyCharacteristic.PEAT))
                .abv(40.0)
                .volume(700.0)
                .nation("스코틀랜드")
                .region("아일라")
        ...
        sampleWhiskeys.add(Whiskey.builder()
                ...
                .category(WhiskeyCategory.BLENDED)
        ...
        sampleWhiskeys.add(Whiskey.builder()
                ...
                .brand("Guinness")
                .category(WhiskeyCategory.BEER_SOJU)
                .characteristics(List.of())
                .abv(4.2)
                .volume(440.0)
                .nation("영국")
